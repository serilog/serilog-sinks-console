...
{
    class ThemedJsonMultilineValueFormatter : ThemedValueFormatter
    {
        ...
        public ThemedJsonMultilineValueFormatter(ConsoleTheme theme, IFormatProvider formatProvider)
            : base(theme)
        {
        ...
        {
            return new ThemedJsonMultilineValueFormatter(theme, _formatProvider);
        }
